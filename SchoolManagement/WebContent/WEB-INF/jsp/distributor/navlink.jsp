...
<nav class="navbar navbar-default navbar-fixed-top" style="margin:0px;">
	...
	<span id="school">Welcome Distributor</span>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
		...
		<li ><a href="showStuAdmin">Students</a></li>
		<li><a href="senderNameAdmin">Sender Name</a></li>
					<li class="config"><span class="glyphicon glyphicon-triangle-bottom" style="color:green" ></span>Configuration
					<ul class="configlinks" style="list-style-type:none;">
					<li><a href="newClassAdmin"> New Class</a></li>
					<li><a href="newDivisionAdmin"> New Division</a></li>
					<li><a href=""> New Sport</a></li>
					
					</ul>
					</li>
					<li class="config"><span class="glyphicon glyphicon-triangle-bottom" style="color:green" ></span>Activities
		<ul class="configlinks" style="list-style-type:none;">
...
<div class="col-md-2 hidden-xs sidelink" >
	...
	<li class="active"><a href="addSchAdmin">School</a></li>
		<li ><a href="showStuAdmin">Students</a></li>
		<li><a href="senderNameAdmin">Sender Name</a></li>
		<li class="config">Configuration<span class="glyphicon glyphicon-triangle-bottom pull-right"  ></span>
					...
					<li><a href="newClassAdmin"> New Class</a></li>
					<li><a href="newDivisionAdmin"> New Division</a></li>
					<li><a href="newCategoryAdmin">New Category</a></li>
