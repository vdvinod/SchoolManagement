...
<body>
	<div class="container-fluid">
		<div class="row">
			...
			<div
				class="col-md-10 col-xs-10 col-sm-10 col-md-offset-2 col-sm-offset-2"
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form:form action="addDivisionAdmin" modelattribute="newDivision">
