...
<body >
	<div class="container-fluid">
		<div class="row">
			...
			<div
				class="col-md-10 col-xs-12 col-sm-12 col-md-offset-2 col-sm-offset-2"
				...
				<div class="panel panel-default" id="studentInput"
					...
					<div class="panel-body">
						...
						<div class="table-responsive">
							...
							<form:form action="editStudentAdmin" method="POST"
								modelattribute="newStudent">
								<input type="text" name="schoolId" id="schoolId" value="${editStudent.schoolId}" hidden>
								...
								<table class="table ">
									...
									<tr>
										<td><input type="text" class="form-control" value="${schoolName }" disabled>
										</td>
										<td><select name="standard" id="standard" onchange="streamActions(this.value)"
											class="form-control">
												<option value="${editStudent.standard}" label="${editStudent.standard}" />
												<core:forEach items="${className}" var="classDeatils">
									...
									<tr>
										<td><select name="division" id="division"
											class="form-control">
												...
												<core:forEach items="${divisionName}" var="divDeatils">
													<option value="${divDeatils}">${divDeatils}</option>
												</core:forEach>
										</select></td>
										<td id="stream1"><select name="stream" class="form-control">
									...
									<tr>
										<td><input type="text" class="form-control" name="rollNo"
											value="${editStudent.rollNo}"></td>
										<td><input type="text" class="form-control" name="uniqueId"
											value="${editStudent.uniqueId}"></td>
									...
									<tr>
										<td><input type="text" class="form-control"
											value="${editStudent.stuFirstName}" name="stuFirstName"></td>
										<td><input type="text" class="form-control"
											value="${editStudent.stuMiddleName}" name="stuMiddleName"></td>
									</tr>
									<tr>
										<th>(Last)</th>
										<th>Mother's Name</th>
									...
									<tr>
										<td><input type="text" class="form-control"
											value="${editStudent.stuLastName}" name="stuLastName"></td>
										<td><input type="text" class="form-control"
											value="${editStudent.motherName}" name="motherName"></td>
									</tr>
									<tr>
										<th>Nationality</th>
										<th>Mother Tongue</th>
									...
									<tr>
										<td><input type="text" class="form-control"
											value="${editStudent.nationality}" name="nationality"></td>
										<td><input type="text" class="form-control"
											value="${editStudent.motherTongue}" name="motherTongue"></td>
									</tr>
									<tr>
										<th>Religion</th>
										<th>Cast</th>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="cast"
											value="${editStudent.cast}"></td>
									</tr>
									<tr>
										<th>Sub Cast</th>
										<th>Birth Place</th>
									...
									<tr>
										<td><input type="text" class="form-control" name="subCast"
											value="${editStudent.subCast}"></td>
										<td><input type="text" class="form-control" name="birthPlace"
											value="${editStudent.birthPlace}"></td>
									</tr>
									<tr>
										<th>Taluka</th>
										<th>District</th>
									...
									<tr>
										<td><input type="text" class="form-control" name="taluka"
											value="${editStudent.taluka}"></td>
										<td><input type="text" class="form-control" name="district"
											value="${editStudent.district}"></td>
									</tr>
									<tr>
										<th>State</th>
										<th>Country</th>
									...
									<tr>
										<td><input type="text" class="form-control" name="state"
											value="${editStudent.state}"></td>
										<td><input type="text" class="form-control" name="country"
											value="${editStudent.country}"></td>
									</tr>
									<tr>
										<th>Date Of Birth</th>
									...
									<tr>
										<td><input type="text" name="mobileNo"
											value="${editStudent.mobileNo}" class="form-control"></td>
										<td colspan="2"><select name="category" class="form-control">
												<option value="${editStudent.category}" label="${editStudent.category}" />
									...
									<tr>
										<td><input type="text" name="bankName"
											value="${editStudent.bankName}" class="form-control"></td>
										<td><input type="text" name="bankAccNo"
											value="${editStudent.bankAccNo}" class="form-control"></td>
									...
									<tr>
										<td colspan="2"><input type="text" name="branchOrIfsc"
											value="${editStudent.branchOrIfsc}" class="form-control"></td>
									</tr>
									<tr>
										<td colspan="2"><div class="alert alert-info"
									...
									<tr>
										<td><input type="text" name="previousSchName"
											value="${editStudent.previousSchName}" class="form-control"></td>
										<td><input type="text" name="previousSchClass"
											value="${editStudent.previousSchClass}" class="form-control"></td>
									</tr>
