...
//get school key 
function getSchKey(val)
{
	document.getElementById("schKey").value=val;
	}
</script>
</head>
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<jsp:include
					page="/WEB-INF/jsp/admin/navlink.jsp" />
			<div class="col-md-10 col-xs-10 col-sm-10 col-md-offset-2 col-sm-offset-2" style="padding-top:56px">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form:form action="addClassAdmin" modelattribute="newClass">
							<input type="text" name="schoolId" id="schKey" hidden>
							<table class="table ">
							...
							<tr>
								...
								<input type="button" value="Add Row" name="btnAdd" class="btn-info" onclick="addRow();">
